export default function Header() {
  return (
    <div className="pointer-events-none absolute bottom-0 left-0 z-[500] flex w-min flex-col items-start p-3 text-center drop-shadow-[2px_2px_2px_#232634] sm:top-0">
