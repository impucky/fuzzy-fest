export default function Header() {
  return (
    <div className="pointer-events-none absolute bottom-0 left-0 z-[500] flex h-fit w-min flex-col items-start p-1 text-center drop-shadow-[2px_2px_2px_#232634] sm:p-3 lg:top-0">
